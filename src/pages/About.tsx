  ...
  return (
    <Style>
      ...
      <div style={{ background: "rgb(127, 155, 171)", padding: "30px" }}>
        ...
        <h2>
          If you are experiencing an emergency, get immediate support (available
          24/7):
        </h2>
        <div className="dropdown-container">
          <h4 onClick={toggleDropdown1}>
            If you are suicidal or in emotional distress, consider using the 988
          ...
          <ul style={{ display: `${isOpen1 ? "block" : "none"}` }}>
            <li>
              ...
              counselor. The Lifeline provides 24-hour, confidential support to
              anyone in suicidal crisis or emotional distress. You can reach a
              specialized LGBTQI+ affirming counselor by texting “Q” to 988 or
              by calling 988 and pressing “3.”
            </li>
            <li>
        ...
        <div className="dropdown-container">
          ...
          <ul style={{ display: `${isOpen2 ? "block" : "none"}` }}>
            <li>
              Call 988, then press “1.” You can also text 838255 or chat online
              . The Veterans Crisis Line is a 24-hour, confidential resource
              that connects veterans with a trained responder. The service is
              available to all veterans and those who support them, even if they
              are not registered with the VA or enrolled in VA healthcare.
            </li>
        ...
        <div className="dropdown-container">
          ...
          <ul style={{ display: `${isOpen3 ? "block" : "none"}` }}>
            ...
            <li>
              ...
              disaster. The 24-hour, confidential helpline offers interpretation
