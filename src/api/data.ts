...
export const helpingOptions = [
  ...
  {
    role: "Family and caregivers",
    image: "role-family.webp",
    messages: [
  ...
  {
    role: "Journalists and media",
    image: "role-journalist.svg",
    messages: [
